...
CIMSH.method.output_parameter_group("method_curved_surface_generate", ["CAD_file", "control_point"])
...
CIMSH.procedure.relate("curved_surface_generate", ['blade', 'molded_line'], "method_curved_surface_generate")
CIMSH.procedure.relate("blade_generate", ['blade', 'molded_line'], "method_blade_generate")
