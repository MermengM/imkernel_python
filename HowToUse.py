...
CIMSH.element.add_parameter_data(0, 'molded_line', 'eleven_parameter', [1, 2, 3, 4])
print(CIMSH)
# # 创建Element实例
# CIMSH = System()
# # create(id, description, parent_id, is_tag)
...
# CIMSH.method.add_data(['001', '001', '001', '001', '001', '001', '001', '001', '001', '001', '001', '001', '001', '001', '001', '001'])
# print(CIMSH)
